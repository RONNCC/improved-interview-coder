...
mkdir -p ~/Library/Application\ Support/ninja-coder/temp
mkdir -p ~/Library/Application\ Support/ninja-coder/cache
mkdir -p ~/Library/Application\ Support/ninja-coder/screenshots
mkdir -p ~/Library/Application\ Support/ninja-coder/extra_screenshots
